...
<form method="POST" class="row g-3"  action="{{route('htSendReply')}}">
    @csrf
    <div class="col-md-4">
      ...
      <div class="col-md-12">
        ...
        <div class="col-md-12">
            ...
            <a href="/myMessages"  class="btn btn-danger" style="float:right"> Back to Messages </a>
        </div>
    </div>
</form>
@endforeach
